...
public class ClientThread extends Thread{
    ...
    public ClientThread(ClientOne client, Socket socket, DataInputStream dis, DataOutputStream dos) {
        this.client = client;
        this.socket = socket;
        this.dis = dis;
        this.dos = dos;
    ...
    public void run() {
        try {
            ...
            File filename = new File((new File("D:")).getAbsolutePath() + File.separatorChar + "dhrt1.txt"); // 要读取以上路径的input。txt文件
        ...
        while (true) {
            try {
                ...
                if (answer.equals("exit")) {
                    File writeName = new File((new File("D:")).getAbsolutePath() + File.separatorChar + "dhrt1.txt");
